...
<head>
  ...
  <title>Login &mdash; Petugas</title>
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="https://i.pinimg.com/originals/11/65/9f/11659f6537bf4843676e6055b5dd017c.png" alt="logo" width="100" class="shadow-light rounded-circle">
            </div>
            <?php 
                 if(isset($_GET['pesan'])){
                  if($_GET['pesan']=="gagal"){
